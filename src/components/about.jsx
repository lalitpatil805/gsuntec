    ...
    return (
        <>  
            <div>
                <Container>
                    <Row>
                        <Col xs={1}><h4 style={{ writingMode: "vertical-rl", transform: "rotate(180deg)", color: "blue", position:'relative',animationName:'mymove',animationDuration:'1s' }}>WHO  WE  ARE</h4></Col>
                        <Col xs={3}><h4 style={{ marginRight: "30%", marginTop: "25%",position:'relative',animationName:'mymove',animationDuration:'1s' }}>Know<br /> About us</h4></Col>
                        <Col xs={8} style={{ fontSize: "17px", fontFamily: "Calibri",textAlign:'left',position:'relative',animationName:'myfirst',animationDuration:'1s' }}> <p>We Are The Fast Growing Consulting And Outsourcing Software Company. We Have A Team Of Innovative Experienced<br />
