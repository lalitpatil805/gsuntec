  ...
  return (
    <Carousel data-bs-theme="dark">
      ...
      <Carousel.Item>
        ...
        />
        <Carousel.Caption>
          <h5 style={{fontSize:"50px", color: 'white', fontWeight:'bold',marginTop:'-30%'}}>Predictive Analytics</h5>
      ...
      <Carousel.Item>
        ...
        />
        <Carousel.Caption>
          <h5 style={{fontSize:"50px", color: 'white',fontWeight:'bold',marginTop:'-30%'}}>Modernization</h5>
      ...
      <Carousel.Item>
        ...
        />
        <Carousel.Caption>
          <h5 style={{fontSize:"50px", color: 'white',fontWeight:'bold',marginTop:'-30%'}}>Software Engineering</h5>
