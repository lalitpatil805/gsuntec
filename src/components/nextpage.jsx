...
function Nextpage() {
  return (
    ...
    <div>
        ...
        <p style={{color:'#7a7a7a',marginBottom:'1.75em'}}>Our mission is rather simple; Global Suntech is committed to helping its customers with their goal and driving ambition to be the trusted partner of choice, delivering reliable, complete<br/> floating production solutions that create value for our clients, by sustainably and passionately leveraging the Company’s technology and operating experience.</p>
    </div><br/>
    
    <div style={{display:'flex',justifyContent:'space-around', flexDirection:'row', flexWrap:'wrap'}}>
        
        <div style={{boxSizing:"border-box", height:'650px', width:'450px', border:'1px solid black'}}><br/><br/>
    <img style={{height:'250px', width:'430px'}} src={Technology} /><br/><br/>
    <h3>Technology</h3><br/>
    <p style={{opacity:'0.9'}}>For Automation, Productivity And Convenience<br/> Throughout All Industries – Consumer And Business-To-  <br/>Business.Technology Has Greater Impact Effects On<br/> Business Operations. Technology Helps Businesses To  <br/> Remain Innovative, Competitive, And Match The Current<br/> Challenges.No Matter The Size Of Organization,<br/> Technology Has Both Tangible And Intangible Benefits.<br/> We Provide Customers Our Expertise And Experiences To<br/> Achieve Goals And Aspirations</p>
    </div>

        <div style={{boxSizing:"border-box", height:'650px', width:'450px', border:'1px solid black'}}><br/><br/>
    <img style={{height:'250px', width:'430px'}} src={Methodology} /><br/><br/>
    <h3>Methodology</h3><br/>
    <p style={{opacity:'0.9'}}>Selecting Right Methodology Is The Crucial To Getting<br/> The Job Right. The Best Set Of Processes For Your<br/> Organization Might Be A Combination Of Frameworks And<br/> Methodologies Rather Than Just One. Our Clients Depend<br/> On Our Ability To Deliver Based On Their Business<br/> Processes And Domain. Right Methology and software<br/> solution is necessary for streamlining work process,<br/> improving business productivity, cutting down costs and<br/> solving other major business tasks.</p>
    </div>

        <div style={{boxSizing:"border-box", height:'650px', width:'450px', border:'1px solid black'}}><br/><br/>
    <img style={{height:'250px', width:'430px'}} src={Businesschallenge} /><br/><br/>
    <h3>Business Challenges</h3><br/>
    <p style={{opacity:'0.9'}}>The Complexity Of A Business Book Goes Up With Each<br/> Business. We Live In Rapidly Changing Times, Especially<br/> For Businesses. We Are Leading Software Company<br/> Providing Smart Solutions To Address Your Business<br/> Challenges. We Go Above And Beyond To Help Client<br/> Achieve their Business Objectives And Overcome<br/> Business Challaenges. Our Experience And Experise Is<br/> The Key To Our Objectivity, And Allows Our Experts To<br/> Provide Best Technical Solutions That Clients Can Trust.</p>
    </div>
